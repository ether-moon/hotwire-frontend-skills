...
class LyricsController < ApplicationController
  ...
  def show
    ...
    if LYRICS[time]
      render html: helpers.turbo_frame_tag("lyrics") do
        helpers.content_tag(:div, LYRICS[time].html_safe, style: "view-transition-name: fly-out")
      end
    else
      head :not_found
    end
...
::view-transition-old(fly-out) {
  animation-name: fade-out, fly-out;
